...
<div class="card">
  ...
  <?php else: ?>
    ...
    <style>
      ...
      /* Zebra rows: lavender + soft blue */
      .ag-theme-quartz.appt-theme .ag-row-odd { background: #f3f0ff; }
      .ag-theme-quartz.appt-theme .ag-row-even { background: #f0f9ff; }
      /* Stronger hover so it’s distinct from both stripes */
      .ag-theme-quartz.appt-theme .ag-row-hover { background: #dbeafe !important; }
      ...
      .inline-input { height: 32px; padding: 4px 8px; font-size: 13px; background:#ffffff; border:1px solid #d1d5db; border-radius:8px; color:#111827; }
      .inline-input:focus { outline:none; box-shadow: 0 0 0 2px rgba(90,103,216,0.25); border-color:#818cf8; background:#ffffff; }
